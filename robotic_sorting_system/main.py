...
def main():
    ...
    # Allow the window to be maximized while preserving the true 16:9 aspect ratio
    cv2.namedWindow("Robotic Arm Object Sorting", cv2.WINDOW_NORMAL | cv2.WINDOW_KEEPRATIO)
